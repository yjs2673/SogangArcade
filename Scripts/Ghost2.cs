...
public class Ghost2 : MonoBehaviour
{
    ...
    void Start() {
        ...
        waypoints = new Vector2[] // 정사각형의 꼭짓점 좌표 설정
        {
            ...
            startPosition + Vector2.right * widthLength, // 오른쪽
            startPosition + Vector2.right * widthLength + Vector2.up * heightLength, // 오른쪽 위
            startPosition + Vector2.up * heightLength, // 위
        };
