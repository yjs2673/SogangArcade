...
public class Monster_square_4 : MonoBehaviour // 2사분면 시작
{
    ...
    void Start() {
        ...
        waypoints = new Vector2[] // 정사각형의 꼭짓점 좌표 설정
        {
            ...
            startPosition - Vector2.up * sideLength, // 아래쪽
            startPosition + (Vector2.right - Vector2.up) * sideLength, // 아래 오른쪽
            startPosition + Vector2.right * sideLength, // 오른쪽
        };
